...
export default function ReportsCenter() {
  ...
  const handleExport = async (reportKey, reportName, format) => {
    ...
    try {
      ...
      if (reportKey === 'RFQ') {
        const res = await axios.get('http://localhost:8080/api/rfqs');
        ...
        const res = await axios.get('http://localhost:8080/api/purchase-orders');
        ...
        const res = await axios.get('http://localhost:8080/api/material-uploads');
        ...
        const res = await axios.get('http://localhost:8080/api/mtc-documents');
        ...
        const res = await axios.get('http://localhost:8080/api/grns');
